...
<div class="card">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="text-sm text-muted"><i class="bi bi-geo-alt"></i>
                            {{ Str::limit($sk->dia_diem ?: 'Chưa cập nhật', 30) }}
                        </div>
                    </td>
    ...
    @if($suKien->hasPages())
    <div style="padding:var(--space-md) 20px;border-top:1px solid var(--border-light);display:flex;justify-content:center;">{{ $suKien->links() }}</div>
    @endif
</div>
