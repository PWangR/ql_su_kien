...
class UpdateSuKienRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'so_lan_diem_danh_yeu_cau' => 'required|integer|in:1,2',
    ...
    public function messages(): array
    {
        return [
            ...
            'so_lan_diem_danh_yeu_cau.required' => 'Vui lòng chọn chế độ điểm danh.',
            'so_lan_diem_danh_yeu_cau.in' => 'Chế độ điểm danh chỉ hỗ trợ 1 lần hoặc 2 lần.',
            'trang_thai.in' => 'Trạng thái sự kiện không hợp lệ (hỗ trợ: sắp tổ chức, đang diễn ra, đã kết thúc, hủy).',
            'module_schema_json.required' => 'Thiếu cấu trúc module của bài đăng.',
