...
// Real-time status stats (need to calculate in PHP)
...
<div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            $c = $colorMap[$sk->trang_thai_thuc_te] ?? $colorMap['da_ket_thuc'];
                            @endphp
                    ...
                    @empty
                    <tr>
                        <td colspan="6" style="text-align:center;color:var(--text-light);padding:30px;">Chưa có sự kiện nào</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
    ...
    <div class="card" style="grid-column:1/-1;margin-top:20px;">
        <div class="card-header">
            <div class="card-title"><i class="bi bi-clipboard-check" style="color:var(--primary)"></i> Đăng ký gần đây</div>
            <a href="{{ route('admin.su-kien.index') }}" class="btn btn-primary btn-sm">
        ...
        <div class="table-resp">
            <table>
                ...
                <tbody>
                    ...
                    @empty
                    <tr>
                        <td colspan="5" style="text-align:center;color:var(--text-light);padding:30px;">Chưa có đăng ký nào</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
