...
.page-hero h1 { font-family:'Montserrat',sans-serif; font-size: 28px; font-weight: 800; }
.page-hero p  { color: #94a3b8; margin-top: 6px; font-size: 14px; }
...
.filter-input { padding: 9px 14px; border: 1.5px solid #e2e8f0; border-radius: 8px; font-size: 14px; font-family: 'Inter', sans-serif; outline: none; transition: border-color 0.2s; }
...
.event-card { background: #fff; border-radius: 16px; border: 1px solid #e2e8f0; overflow: hidden; transition: transform 0.2s, box-shadow 0.2s; }
.event-card:hover { transform: translateY(-4px); box-shadow: 0 12px 32px rgba(0,0,0,0.1); }
.event-img { height: 160px; background: linear-gradient(135deg, #dbeafe, #eff6ff); display: flex; align-items: center; justify-content: center; position: relative; overflow: hidden; }
.event-img img { width: 100%; height: 100%; object-fit: cover; }
.event-body { padding: 16px; }
.event-title { font-size: 15px; font-weight: 700; color: #1e293b; margin-bottom: 10px; line-height: 1.4; }
.event-meta-row { display: flex; align-items: center; gap: 6px; font-size: 12.5px; color: #64748b; margin-bottom: 4px; }
...
.btn-detail { background: #eff6ff; color: #2563eb; border: none; border-radius: 8px; padding: 6px 16px; font-size: 13px; font-weight: 600; cursor: pointer; text-decoration: none; transition: all 0.2s; display: inline-flex; align-items: center; gap: 5px; }
.btn-detail:hover { background: #2563eb; color: #fff; }
.badge-type { position: absolute; top: 10px; left: 10px; background: rgba(37,99,235,0.9); color: #fff; font-size: 11px; font-weight: 600; padding: 3px 10px; border-radius: 6px; }
.badge-full { position: absolute; top: 10px; right: 10px; background: rgba(239,68,68,0.9); color: #fff; font-size: 11px; font-weight: 600; padding: 3px 10px; border-radius: 6px; }
</style>
@endsection
...
<div class="event-grid">
    ...
    <div class="event-card">
        ...
        <div class="event-body">
            <h3 class="event-title">{{ Str::limit($sk->ten_su_kien, 52) }}</h3>
